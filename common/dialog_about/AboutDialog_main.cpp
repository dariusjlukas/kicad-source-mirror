...
#define CONTRIB_DEV _( "Additional Contributions By")
    ...
    ADD_DEV( wxT( "Christopher Alexander" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Alexander Boehm" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Kevin Bralten" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Matt Campbell" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Jan Dorniak" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Steven A. Falco" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Quentin Freimanis" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Dominique Fuchs" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Adrián García" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Alessandro Gatti" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Zenn Geeraerts" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Paweł Gorgoń" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Connor Goss" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Brendan Hickey" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Eli Hughes" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Matt Kosman" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Brian Lu" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Magnus Lundmark" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Philippe Maire" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Ian McKernan" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Juho Ovaska" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Damjan Prerad" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Zlatan Radovanovic" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "David Rees" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Olliver Schinagl" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "David Schneider" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Alihossein Sepahvand" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Marco Serantoni" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Julien Serin" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Michal Suchánek" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Salvador E. Tropea" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Andrej Valek" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Henri Valta" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Dave Vandenbout" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Raman Varabets" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Fabio Varesano" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Akhil Velagapudi" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Emmanuel Vera" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Martin Whitaker" ), CONTRIB_DEV );
    ADD_DEV( wxT( "Addo White" ), CONTRIB_DEV );
    ...
    ADD_DEV( wxT( "Adam Wysocki" ), CONTRIB_DEV );
...
#define ADD_TRANSLATOR( name, category ) aInfo.AddTranslator( new CONTRIBUTOR( name, category ) )
    ...
    ADD_TRANSLATOR( wxT( "Michal Kundrát" ), wxS( "Czech (CS)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Hynek Štětina" ), wxS( "Czech (CS)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Christian Schlüter" ), wxS( "German (DE)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Theodoros Asimakopoulos" ), wxS( "Greek (el_GR)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Echedey" ), wxS( "Spanish (ES)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Tomás Mora" ), wxS( "Spanish (ES)" ) );
    ADD_TRANSLATOR( wxT( "Gallego Novato" ), wxS( "Spanish (ES)" ) );
    ADD_TRANSLATOR( wxT( "Jose Perez" ), wxS( "Spanish (ES)" ) );
    ADD_TRANSLATOR( wxT( "Francisco Jose Rey" ), wxS( "Spanish (ES)" ) );
    ADD_TRANSLATOR( wxT( "Gaston Schelotto" ), wxS( "Spanish (ES)" ) );
    ADD_TRANSLATOR( wxT( "uLe" ), wxS( "Spanish (ES)" ) );
    ...
    ADD_TRANSLATOR( wxT( "lylythechosenone" ), wxS( "Spanish - Latin American (ES)" ) );
    ADD_TRANSLATOR( wxT( "uLe" ), wxS( "Spanish - Latin American (ES)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Ricky Tigg" ), wxS( "Finnish (FI)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Luca Mattii" ), wxS( "Italian (IT)" ) );

    ADD_TRANSLATOR( wxT( "2tama3" ), wxS( "Japanese (JA)" ) );
    ...
    ADD_TRANSLATOR( wxT( "co8 j" ), wxS( "Japanese (JA)" ) );
    ...
    ADD_TRANSLATOR( wxT( "DevAny" ), wxS( "Korean (KO)" ) );
    ...
    ADD_TRANSLATOR( wxT( "kmn4555" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "KwonHyeokbeom" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "Pedro Moreira" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "Jason Son" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "YunJiSang" ), wxS( "Korean (KO)" ) );
    ...
    ADD_TRANSLATOR( wxT( "김유진" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "김인수" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "김호진" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "남우근" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "박기정" ), wxS( "Korean (KO)" ) );
    ADD_TRANSLATOR( wxT( "박세훈" ), wxS( "Korean (KO)" ) );
    ...
    ADD_TRANSLATOR( wxT( "WhiteChairFromIkea" ), wxS( "Lithuanian (LT)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Robin Janssens" ), wxS( "Dutch (NL)" ) );
    ADD_TRANSLATOR( wxT( "johanneswilkens" ), wxS( "Dutch (NL)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Herman van der Vaart" ), wxS( "Dutch (NL)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Stian Kristensen" ), wxS( "Norwegian (NO)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Czam Ciał" ), wxS( "Polish (PL)" ) );
    ...
    ADD_TRANSLATOR( wxT( "szumsky" ), wxS( "Polish (PL)" ) );
    ADD_TRANSLATOR( wxT( "Grzegorz Szymaszek" ), wxS( "Polish (PL)" ) );
    ADD_TRANSLATOR( wxT( "ZbeeGin" ), wxS( "Polish (PL)" ) );

    ADD_TRANSLATOR( wxT( "brunofaus" ), wxS( "Brazilian Portuguese (PT_BR)" ) );
    ADD_TRANSLATOR( wxT( "Augusto Fraga Giachero" ), wxS( "Brazilian Portuguese (PT_BR)" ) );
    ADD_TRANSLATOR( wxT( "Hildo Guillardi Júnior" ), wxS( "Brazilian Portuguese (PT_BR)" ) );
    ADD_TRANSLATOR( wxT( "Pedro Moreira" ), wxS( "Brazilian Portuguese (PT_BR)" ) );
    ADD_TRANSLATOR( wxT( "soldado-do-wolfenstein" ), wxS( "Brazilian Portuguese (PT_BR)" ) );
    ...
    ADD_TRANSLATOR( wxT( "sergio" ), wxS( "Russian (RU)" ) );
    ADD_TRANSLATOR( wxT( "xXx" ), wxS( "Russian (RU)" ) );
    ADD_TRANSLATOR( wxT( "Дмитрий Дёмин" ), wxS( "Russian (RU)" ) );
    ADD_TRANSLATOR( wxT( "МАН69К" ), wxS( "Russian (RU)" ) );

    ADD_TRANSLATOR( wxT( "Hanna Breisand" ), wxS( "Swedish (SV)" ) );
    ADD_TRANSLATOR( wxT( "Stefan Bjornelund the Gnome" ), wxS( "Swedish (SV)" ) );
    ADD_TRANSLATOR( wxT( "Johan Heikkilä" ), wxS( "Swedish (SV)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Joakim Lundborg" ), wxS( "Swedish (SV)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Максим Горпиніч" ), wxS( "Ukrainian (UK)" ) );

    ADD_TRANSLATOR( wxT( "CharlieYu" ), wxS( "Simplified Chinese (zh_CN)" ) );
    ADD_TRANSLATOR( wxT( "David Chen" ), wxS( "Simplified Chinese (zh_CN)" ) );
    ADD_TRANSLATOR( wxT( "Dingzhong Chen" ), wxS( "Simplified Chinese (zh_CN)" ) );
    ADD_TRANSLATOR( wxT( "CloverGit" ), wxS( "Simplified Chinese (zh_CN)" ) );
    ...
    ADD_TRANSLATOR( wxT( "aisuneko icecat" ), wxS( "Simplified Chinese (zh_CN)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Li Yi" ), wxS( "Simplified Chinese (zh_CN)" ) );
    ...
    ADD_TRANSLATOR( wxT( "yanzhen zhu" ), wxS( "Simplified Chinese (zh_CN)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Shuwn Hsu" ), wxS( "Traditional Chinese (zh_TW)" ) );
    ADD_TRANSLATOR( wxT( "Poming Lee" ), wxS( "Traditional Chinese (zh_TW)" ) );
    ADD_TRANSLATOR( wxT( "William Lin" ), wxS( "Traditional Chinese (zh_TW)" ) );
    ADD_TRANSLATOR( wxT( "Oliver0804" ), wxS( "Traditional Chinese (zh_TW)" ) );
    ADD_TRANSLATOR( wxT( "reimu105" ), wxS( "Traditional Chinese (zh_TW)" ) );
    ADD_TRANSLATOR( wxT( "Che-Hsien Su" ), wxS( "Traditional Chinese (zh_TW)" ) );
    ...
    ADD_TRANSLATOR( wxT( "Hesham Eina Abdalla" ), wxS( "Arabic (AR)" ) );
    ADD_TRANSLATOR( wxT( "Djamel Dellaa" ), wxS( "Arabic (AR)" ) );
    ADD_TRANSLATOR( wxT( "Ahmed Elswah" ), wxS( "Arabic (AR)" ) );
    ADD_TRANSLATOR( wxT( "HADJAISSA" ), wxS( "Arabic (AR)" ) );
    ADD_TRANSLATOR( wxT( "Morad Tamer" ), wxS( "Arabic (AR)" ) );

    ADD_TRANSLATOR( wxT( "Adolfo Jayme Barrientos" ), wxS( "Catalan (CA)" ) );
    ADD_TRANSLATOR( wxT( "Marc de Miguel" ), wxS( "Catalan (CA)" ) );
    ADD_TRANSLATOR( wxT( "Rafael Serrano" ), wxS( "Catalan (CA)" ) );
    ADD_TRANSLATOR( wxT( "Arnau Llovet Vidal" ), wxS( "Catalan (CA)" ) );

    ADD_TRANSLATOR( wxT( "Ivan Chuba" ), wxS( "Estonian (ET)" ) );

    ADD_TRANSLATOR( wxT( "Temuri Doghonadze" ), wxS( "Georgian (KA)" ) );

    ADD_TRANSLATOR( wxT( "Viktor Döme" ), wxS( "Hungarian (HU)" ) );
    ADD_TRANSLATOR( wxT( "István Farkas" ), wxS( "Hungarian (HU)" ) );
    ADD_TRANSLATOR( wxT( "Flórián Fuszkó" ), wxS( "Hungarian (HU)" ) );
    ADD_TRANSLATOR( wxT( "Sárkány Lőrinc" ), wxS( "Hungarian (HU)" ) );
    ADD_TRANSLATOR( wxT( "Miklós Márton" ), wxS( "Hungarian (HU)" ) );
    ADD_TRANSLATOR( wxT( "Balázs Meskó" ), wxS( "Hungarian (HU)" ) );
    ADD_TRANSLATOR( wxT( "Hajdu Norbert" ), wxS( "Hungarian (HU)" ) );
    ADD_TRANSLATOR( wxT( "Elek Zoltán" ), wxS( "Hungarian (HU)" ) );

    ADD_TRANSLATOR( wxT( "Reza Almanda" ), wxS( "Indonesian (ID)" ) );
    ADD_TRANSLATOR( wxT( "Jacque Fresco" ), wxS( "Indonesian (ID)" ) );
    ADD_TRANSLATOR( wxT( "Neko Nekowazarashi" ), wxS( "Indonesian (ID)" ) );
    ADD_TRANSLATOR( wxT( "Triyan W. Nugroho" ), wxS( "Indonesian (ID)" ) );

    ADD_TRANSLATOR( wxT( "Rihards Skuja" ), wxS( "Latvian (LV)" ) );

    ADD_TRANSLATOR( wxT( "Mahdi Ahmadzadeh" ), wxS( "Persian (FA)" ) );

    ADD_TRANSLATOR( wxT( "Nicoara Alex" ), wxS( "Romanian (RO)" ) );
    ADD_TRANSLATOR( wxT( "Tatu Bogdan" ), wxS( "Romanian (RO)" ) );
    ADD_TRANSLATOR( wxT( "Alex Gellen" ), wxS( "Romanian (RO)" ) );
    ADD_TRANSLATOR( wxT( "Adrian Scripcă" ), wxS( "Romanian (RO)" ) );

    ADD_TRANSLATOR( wxT( "Luka Borkovic" ), wxS( "Serbian (SR)" ) );

    ADD_TRANSLATOR( wxT( "David Chorváth" ), wxS( "Slovak (SK)" ) );
    ADD_TRANSLATOR( wxT( "Marcel Hecko" ), wxS( "Slovak (SK)" ) );
    ADD_TRANSLATOR( wxT( "Jakub Janek" ), wxS( "Slovak (SK)" ) );
    ADD_TRANSLATOR( wxT( "Andrej Valek" ), wxS( "Slovak (SK)" ) );

    ADD_TRANSLATOR( wxT( "Sašo Domadenik" ), wxS( "Slovenian (SI)" ) );
    ADD_TRANSLATOR( wxT( "Vitan Košpenda" ), wxS( "Slovenian (SI)" ) );
    ADD_TRANSLATOR( wxT( "Mitja Nemec" ), wxS( "Slovenian (SI)" ) );

    ADD_TRANSLATOR( wxT( "தமிழ்நேரம்" ), wxS( "Tamil (TA)" ) );

    ADD_TRANSLATOR( wxT( "YÜKSEL AÇIKGÖZ" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Argeolog" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Mahsum Aslan" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Tevfik Bagcivan" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Bahtiyar Bayram" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Marine Biologist" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Mustafa Selçuk ÇAVDAR" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "dogukansahil" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Erkan" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Oğuz Ersen" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "İclal Gör" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Mert Gülsoy" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Mert Kalkancı" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "metin kiruc" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Gökhan Koçmarlı" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Niyazi" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Ahmet Saygın ÖĞÜLMÜŞ" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Ertuğrul Reisoğlu" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "Murat Ursavaş" ), wxS( "Turkish (TR)" ) );
    ADD_TRANSLATOR( wxT( "VEDAT YAMAN" ), wxS( "Turkish (TR)" ) );

    ADD_TRANSLATOR( wxT( "Nguyen Van Dien" ), wxS( "Vietnamese (VI)" ) );
    ADD_TRANSLATOR( wxT( "Trần Phi Hải" ), wxS( "Vietnamese (VI)" ) );
    ADD_TRANSLATOR( wxT( "Nguyễn Ngọc Khánh" ), wxS( "Vietnamese (VI)" ) );
    ADD_TRANSLATOR( wxT( "lê văn lập" ), wxS( "Vietnamese (VI)" ) );
    ADD_TRANSLATOR( wxT( "Bế Trọng Nghĩa" ), wxS( "Vietnamese (VI)" ) );
    ADD_TRANSLATOR( wxT( "An Nguyen" ), wxS( "Vietnamese (VI)" ) );
    ADD_TRANSLATOR( wxT( "Phạm Minh Tấn" ), wxS( "Vietnamese (VI)" ) );
